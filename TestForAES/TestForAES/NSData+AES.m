...
{
    //kCCKeySizeAES256 32位加密  kCCKeySizeAES128 16位加密 kCCKeySizeAES192 24位加密 这边测试的ECB CBC模式
    ...
    CCCryptorStatus cryptorStatus = CCCrypt(operation, kCCAlgorithmAES128, padding?kCCOptionPKCS7Padding:kCCOptionECBMode,
